...
from api.v1.ppt.endpoints.narrative import NARRATIVE_ROUTER
from api.v1.ppt.endpoints.guide import GUIDE_ROUTER
from api.v1.ppt.endpoints.agent_chat import AGENT_CHAT_ROUTER
...
API_V1_PPT_ROUTER.include_router(NARRATIVE_ROUTER)
API_V1_PPT_ROUTER.include_router(GUIDE_ROUTER)
API_V1_PPT_ROUTER.include_router(AGENT_CHAT_ROUTER)
