...
> = ({ data: slideData }) => {
  ...
  return (
    <>
      ...
      <div
        className="w-full rounded-sm max-w-[1280px] max-h-[720px] aspect-video relative z-20 mx-auto overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="flex h-full px-16 pb-16">
          ...
          <div className="flex-1 pr-16 flex flex-col justify-center text-left">
            <div className="flex flex-col items-start justify-center h-full">
              <h2 className="text-5xl font-bold mb-8 leading-tight">
                {slideData?.title}
              </h2>

              <div className="text-lg leading-relaxed font-normal mb-12 max-w-lg">
                  ...
                  <div className="flex-shrink-0">
                    {category.icon?.__icon_url__ && (
                      <img
                        ...
                        className="w-12 h-12"
                        style={{ filter: 'var(--theme-icon-filter, invert(1))' }}
                      />
                    )}
                  </div>
                  <div className="text-left">
                    <h3 className="text-xl font-semibold mb-1" style={{ color: 'var(--theme-accent)' }}>
                      {category.title}
                    </h3>
