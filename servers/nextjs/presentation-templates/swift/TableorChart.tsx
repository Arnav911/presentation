  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-12 pt-6 flex-1 min-h-0">
          {mode === "table" ? (
            <div className="rounded-xl p-5 h-full flex flex-col" style={{ backgroundColor: 'var(--primary-accent-color, #BFF4FF)' }}>
              <div className="overflow-auto rounded-lg bg-white ring-1 flex-1 custom-scrollbar" style={{ borderColor: 'rgba(0,0,0,0.08)' }}>
