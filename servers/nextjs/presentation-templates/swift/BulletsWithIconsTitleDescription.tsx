...
const ItemSchema = z
  ...
  .default({
    icon: {
      __icon_url__:
        "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg",
...
const Schema = z
    ...
    items: z
      ...
      .default([
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
  ...
  .default({
    ...
    items: [
      {
        icon: { __icon_url__: "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the first icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the second icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the third icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the fourth icon explaining the point.",
      },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col px-12 pt-4 flex-1 min-h-0">
          <div className="grid grid-cols-[1fr_0.8fr] gap-12 items-start pt-6">
            <div className="text-[44px] leading-[1.1] font-semibold line-clamp-3" style={{ color: "var(--text-heading-color, #111827)" }}>
              {renderTitle(slideData.title)}
            </div>
            <div className="pt-2">
              {slideData.sideHeading && (
                <div className="text-[17px] mb-2 font-semibold line-clamp-2" style={{ color: "var(--text-heading-color, #111827)" }}>
                  {slideData.sideHeading}
                </div>
              )}
              {slideData.sideParagraph && (
                <div className="text-[14px] leading-[1.6] line-clamp-5 overflow-hidden" style={{ color: "var(--text-body-color, #6B7280)" }}>
                  {slideData.sideParagraph}
                </div>
              )}
            </div>
              ...
              {items.slice(0, 4).map((item, idx) => (
                <div key={idx} className="flex flex-col items-center text-center">
                  <div className="relative">
                    <div
                      className="w-32 h-32 rounded-full flex items-center justify-center shadow"
                  ...
                  <div className="mt-4 text-[15px] font-semibold line-clamp-2" style={{ color: "var(--text-heading-color, #111827)" }}>
                    {item.title}
                  </div>
                  <div className="mt-2 text-[12px] leading-[1.5] max-w-[260px] line-clamp-3 overflow-hidden" style={{ color: "var(--text-body-color, #6B7280)" }}>
                    {item.description}
                  </div>
                </div>
              ))}
