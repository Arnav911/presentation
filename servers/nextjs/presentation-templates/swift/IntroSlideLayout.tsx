...
const IntroSlideLayout: React.FC<SlideLayoutProps> = ({ data: slideData }) => {
  return (
    <>
      ...
      >
        {/* Right panel image */}
        <div className="absolute top-0 right-0 h-full w-[42%] overflow-hidden" style={{ backgroundColor: 'var(--primary-accent-color, #f3f4f6)' }}>
          <img
        ...
        <div className="flex flex-col justify-center h-full max-w-[55%] px-12 pb-12 relative z-30">
          <div className="pt-4">
            <h1
              className="text-[52px] leading-[1.1] tracking-tight font-semibold"
