...
const TableOfContents: React.FC<SlideLayoutProps> = ({ data: slideData }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col justify-center h-full px-12 pb-16">
          <div className="mb-6">
            <h1 className="text-[44px] leading-[1.1] font-semibold" style={{ color: "var(--text-heading-color, #111827)" }}>{slideData?.title}</h1>
          </div>

          {/* List */}
          <div>
            <div className="grid grid-cols-2 gap-x-12 gap-y-4 max-w-[1180px]">
