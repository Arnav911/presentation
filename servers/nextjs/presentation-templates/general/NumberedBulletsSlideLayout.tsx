    ...
    return (
        <>
            ...
            >
                ...
                <div className="px-8 sm:px-12 lg:px-16 pt-8 pb-4 h-full">
                    {/* Top Section - Title and Image */}
                    <div className="flex items-start justify-between mb-4">
                        {/* Title Section */}
                        <div className="flex-1 pr-8">
                            <h1 style={{ color: "var(--text-heading-color,#111827)" }} className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-2">
                                {slideData?.title || 'Market Validation'}
                            </h1>
                            {/* Purple accent line */}
                            <div style={{ background: "var(--text-heading-color,#9333ea)" }} className="w-16 h-1 bg-purple-600 mb-4"></div>
                        </div>
                        ...
                        {bulletPoints.map((bullet, index) => (
                            <div key={index} className="flex items-start space-x-3">
                                ...
                                <div className="flex-shrink-0">
                                    <div style={{ color: "var(--text-heading-color,#111827)" }} className="text-2xl sm:text-3xl font-bold text-gray-900">
                                ...
                                <div className="flex-1 pt-1">
                                    <h3 style={{ color: "var(--text-heading-color,#111827)" }} className="text-base sm:text-lg font-bold text-gray-900 mb-2">
                                        {bullet.title}
                                    </h3>
                                    <p style={{ color: "var(--text-body-color,#4b5563)" }} className="text-xs sm:text-sm text-gray-700 leading-relaxed text-left">
                                        {bullet.description}
                                    </p>
                                </div>
                            </div>
