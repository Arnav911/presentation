...
const metricsWithImageSlideSchema = z.object({
    ...
    image: ImageSchema.default({
        __image_url__: "",
        __image_prompt__: 'Business team analyzing performance metrics and company traction'
    }).meta({
            ...
            >
                ...
                <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
                    ...
                    <div className="flex-1 flex flex-col justify-center pl-8 space-y-4">
                        ...
                        {/* Description */}
                        <p style={{ color: "var(--text-body-color,#4b5563)" }} className="text-xs sm:text-sm lg:text-base text-gray-700 leading-relaxed text-left">
