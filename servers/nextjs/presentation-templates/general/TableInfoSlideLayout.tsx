    ...
    return (
        <>
            ...
            >
                ...
                {/* Main Content */}
                <div className="relative z-10 px-8 sm:px-12 lg:px-16 pt-8 pb-4 flex-1 flex flex-col justify-between">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        {/* Purple accent line */}
                        <div style={{ background: "var(--primary-accent-color,#9333ea)" }} className="w-16 h-1 bg-purple-600 mx-auto"></div>
                    </div>
                                ...
                                <div style={{ backgroundColor: "var(--primary-accent-color,#9333ea)" }}>
                                    <div className="grid gap-px" style={{ gridTemplateColumns: `repeat(${tableHeaders.length}, 1fr)` }}>
                                        {tableHeaders.map((header, index) => (
                                            <div key={index} className="px-3 py-2 font-semibold text-center text-xs sm:text-sm" style={{ color: "var(--text-heading-color,#111827)" }}>
                                                {header}
                                            </div>
                                        ))}
                                    </div>
                    ...
                    <div className="text-center space-y-2">
                        <div className="max-w-4xl mx-auto">
                            <p style={{ color: "var(--text-body-color,#4b5563)" }} className="text-xs sm:text-sm text-gray-700 leading-relaxed">
