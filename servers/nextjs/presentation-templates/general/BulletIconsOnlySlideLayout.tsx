...
const bulletIconsOnlySlideSchema = z.object({
    ...
    bulletPoints: z.array(z.object({
    ...
    })).min(2).max(3).default([
        {
            ...
            icon: {
                __icon_url__: 'https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/code-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://presentation-ai-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/headphones-bold.svg',
    ...
    return (
        <>
            ...
            >
                ...
                {/* Main Content */}
                <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-10 pb-6">
                    {/* Left Section - Title and Bullet Points */}
                    <div className="flex-1 flex flex-col pr-8 min-h-0">
                        {/* Title */}
                        <h1 style={{ color: "var(--text-heading-color,#111827)" }} className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.1] mb-4 text-left max-w-4xl">
                            {slideData?.title || 'Solutions'}
                        </h1>

                        {/* Bullet Points Grid */}
                        <div className={`grid ${getGridClasses(bulletPoints.length)} flex-1 items-start min-h-0 overflow-y-auto pr-2 py-4`}>
