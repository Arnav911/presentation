...
const SidePanel = ({
  ...
  return (
    <>
        ...
        <div className="hidden xl:block fixed left-4 top-1/2 -translate-y-1/2 z-50">
          <ToolTip content="Open Panel">
            <Button
              ...
              className="bg-card hover:bg-zinc-800 border-border border shadow-lg"
            >
        ...
        <div className="xl:hidden fixed left-4 bottom-4 z-50">
          <ToolTip content="Show Panel">
            <Button
              ...
              className="bg-white text-black p-3 rounded-full shadow-lg hover:bg-zinc-200"
            >
      ...
      >
        <div
          className="min-w-[280px] bg-card max-w-[280px] h-[calc(100vh-140px)] m-4 rounded-[24px] hide-scrollbar overflow-hidden shadow-xl border border-border"
        >
          <div
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center justify-start gap-4">
                ...
                <ToolTip content="List Preview">
                  ...
                  >
                    <ListTree
                      className={`${active === "list" ? "text-black" : "text-white"
                        }`}
                      size={20}
                    />
                  </Button>
                  ...
                  presentationData?.slides.map((slide: any, index: number) => (
                    ...
                    >
                      ...
                      <p className="text-sm slide-description">
                        {slide?.content?.title || slide?.content?.mainTitle || slide?.content?.headline || slide?.content?.agencyLabel || slide?.content?.concept || "Generating outline..."}
                      </p>
                    </div>
                  ))
                ) : (
                ...
                {isStreaming ? (
                  ...
                  presentationData?.slides.map((slide: any, index: number) => (
                    <div
                      ...
                      className={` cursor-pointer ring-2 p-1  rounded-md transition-all duration-200 ${selectedSlide === index ? ' ring-white' : 'ring-zinc-800'
                        }`}
                    >
                      ...
                      <div 
                        className="transform scale-[0.2] flex justify-center items-center origin-top-left w-[500%] h-[500%] themed-slide-container"
                        style={{ 
