  ...
  return (
    <>
      ...
      <button
        ...
        className="help-button hidden fixed bottom-6 right-6 h-12 w-12 z-50 bg-[#5146E5] hover:bg-[#4338ca] rounded-full md:flex justify-center items-center cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-110"
      ...
      >
        <div className="bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden">
          {/* Header */}
          <div className="bg-[#5146E5] text-white px-6 py-4 flex justify-between items-center">
            <h2 className="text-lg font-medium">Help Center</h2>
            <button
              onClick={() => setIsOpen(false)}
              className="hover:bg-indigo-700/50 p-1 rounded transition-colors"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          <div className="px-6 pb-3 flex gap-2 overflow-x-auto hide-scrollbar">
            {categories.map((category) => (
              <button
                ...
                className={`px-3 py-1 rounded-full text-sm whitespace-nowrap transition-all duration-200 ${selectedCategory === category
                    ? "bg-[#5146E5] text-white shadow-md shadow-indigo-100"
