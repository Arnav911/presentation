...
const SlideCountSelect: React.FC<{
  ...
  return (
    <Select value={value || ""} onValueChange={onValueChange} name="slides">
      <SelectTrigger
        className="w-[180px] font-instrument_sans font-medium bg-card border-border focus-visible:ring-zinc-700"
      ...
      <SelectContent className="font-instrument_sans">
        ...
        <div
          className="sticky top-0 z-10 bg-card p-2 border-b border-border"
  ...
  <Popover open={open} onOpenChange={onOpenChange}>
    <PopoverTrigger asChild>
      <Button
        ...
        aria-expanded={open}
        className="w-[200px] justify-between font-instrument_sans font-semibold overflow-hidden bg-card hover:bg-zinc-800 border-zinc-800 focus-visible:ring-zinc-700 border-none"
      >
  ...
  return (
    <div className="flex flex-wrap order-1 gap-4 items-center">
      ...
      <button
        ...
        className="ml-auto flex items-center gap-2 text-sm underline underline-offset-4  bg-card hover:bg-zinc-800 border-border focus-visible:ring-zinc-700 border-none p-2 rounded-md font-instrument_sans font-medium text-white"
      >
        ...
        <DialogContent className="max-w-2xl font-instrument_sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              >
                <SelectTrigger className="w-full font-instrument_sans capitalize font-medium bg-zinc-900 border-zinc-800 focus-visible:ring-zinc-700 text-white">
            ...
            {/* Verbosity */}
            <div className="w-full flex flex-col gap-2">
              <label className="text-sm font-semibold text-white">Verbosity</label>
            ...
            {/* Toggles */}
            <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-zinc-900 border border-zinc-800">
              <div className="flex items-center justify-between">
                <label className="text-sm font-semibold text-white">Include table of contents</label>
                <Switch
            ...
            <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-zinc-900 border border-zinc-800">
              <div className="flex items-center justify-between">
                <label className="text-sm font-semibold text-white">Title slide</label>
                <Switch
            ...
            <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-zinc-900 border border-zinc-800">
              <div className="flex items-center justify-between">
                <label className="text-sm font-semibold text-white">Web search</label>
                <Switch
            ...
            <div className="w-full sm:col-span-2 flex flex-col gap-2">
              ...
              <Textarea
                ...
                className="py-2 px-3 border-2 font-medium text-sm min-h-[100px] max-h-[200px] border-zinc-800 bg-zinc-900 text-white focus-visible:ring-offset-0 focus-visible:ring-zinc-700"
              />
            </div>
          </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveAdvanced} className="bg-white text-black hover:bg-zinc-200">Save</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
