...
export const useTemplateLayouts = () => {
          ...
          >
            ...
            >
              <SlideErrorBoundary label={`Slide ${slide.index + 1}`}>
                <Layout data={slide.content} forceTheme={presentationData?.theme?.themeMode || 'light'} />
              </SlideErrorBoundary>
            </TiptapTextReplacer>
          </EditableLayoutWrapper>
        );
  ...
  }, [getTemplateLayout, dispatch, presentationData?.theme?.themeMode]);
